export default function About() {
    return (
        <div className='about-wrapper'>
            <h2>About me</h2>
            <p>
                I’m a full-stack software engineer and UI/UX designer at <strong>IBM</strong>, where I get to bring my
                love for both development and design to life. I’m passionate about creating seamless, user-friendly
                experiences by bridging the gap between code and design. With a strong background in building web
